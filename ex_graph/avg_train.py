...
def get_args():
    ...
    parser.add_argument('--pooling_ratio', type=float, default=0.799915408, help='pooling ratio')
    parser.add_argument('--edge_ratio', type=float, default=0.5, help='pooling ratio')
    parser.add_argument('--dropout_ratio', type=float, default=0, help='dropout ratio')
    parser.add_argument('--lamb', type=float, default=1.0, help='trade-off parameter')
    parser.add_argument('--dataset', type=str, default='ENZYMES', help='DD/PROTEINS/NCI1/NCI109/Mutagenicity/ENZYMES/FRANKENSTEIN')
