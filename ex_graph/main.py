...
def get_args():
    ...
    parser.add_argument('--pooling_ratio', type=float, default=0.29, help='pooling ratio')
    parser.add_argument('--edge_ratio', type=float, default=0.29, help='pooling ratio')
    parser.add_argument('--dropout_ratio', type=float, default=0.61, help='dropout ratio')
