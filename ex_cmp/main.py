...
def get_args():
    ...
    parser.add_argument('--pooling_nodes', type=float, default=0.9, help='pooling ratio')
    parser.add_argument('--pooling_edges', type=float, default=0.9, help='pooling ratio')
    ...
    parser.add_argument('--conv',default='LiCheb',help='GCN/ChebConv/GAT/LiCheb/MeanConv/AttConv')
