...
from layers_conv import GCN,GATConv,ChebConv,LiCheb,MeanConv,AttConv
...
class Model(torch.nn.Module):
    ...
    def forward(self, data):
        ...
        for idx in range(self.num_layers-1):
            ...
            x, edge_index, edge_weight, batch = self.pool(x,x_score, edge_index, edge_weight, batch,self.edge,self.D) # x: [34769, 128]
